...
erbium_soc1sim launcher with the histogram.elf, dumps device memory
...
DEFAULT_ELFS = {
    "soc1sim":    Path("/tmp/erbium-examples-build/soc1sim/src/histogram/histogram.elf"),
    "sys_emu":    Path("/tmp/erbium-examples-build/soc1sim/src/histogram/histogram.elf"),
    "erbium_emu": Path("/tmp/erbium-examples-build/erbium/src/histogram/histogram.elf"),
}
